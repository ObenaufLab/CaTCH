...
message(paste( length(unique(all_tidy[(refcount_Good), bc_id])), "barcode sequences with good readcount in the reference."  ))
...
tmp[, cs := cumsum(N)]
print( DF[ interesting >= tail(tmp[N<10, interesting], 1), .(bc_id, interesting, barcode)] )
