...
# opt <- list(countsFile='/groups/obenauf/Kimon_Froussios/catch_test/process/data1_barcode-counts.txt', summariesFile='/groups/obenauf/Kimon_Froussios/catch_test/process/data1_summary.txt', samples='/groups/obenauf/Kimon_Froussios/catch_test/covars1.txt', resultsDir='/groups/obenauf/Kimon_Froussios/catch_test/results', count_thresh=1)
