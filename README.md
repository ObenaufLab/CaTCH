...
-A FLOAT        Barcode abundance threshold for the report. Barcodes must make up at least this percentage of the sample's reads to be considered abundant                         (Default: 0.005 ie. 0.5% of reads).
