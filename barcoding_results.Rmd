...
```{r pdfstart}
pdf('/Volumes/groups/obenauf/Kimon_Froussios/chris/YUMM17_old/results/YUMM17_barcodes.pdf', paper="a4")
```
...
```{r data}
counts <- fread('/Volumes/groups/obenauf/Kimon_Froussios/chris/YUMM17_old/data/counts.txt')
